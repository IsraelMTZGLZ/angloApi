...
class DAO extends CI_Model{
     ...
     public function selectEntity($entityName,$whereClause = null,$uniqueResult =false)
    {
		...
		public function selectEntityThree($entityName,$whereClauseOne = null,$whereClauseTwo = null,$whereClauseThree = null,$uniqueResult =false)
	 {
			 if ($whereClauseOne) {
	 ...
	 public function selectRow($entityName,$whereClause = null,$uniqueResult =false)
	{
	 ...
	 public function selectTwoEntityRow($entityName,$whereClause = null,$whereClauseTwo = null,$uniqueResult =false)
	{
	...
	public function selectbyThreeEntity($entityName,$whereClause = null,$whereClauseTwo = null,$whereClauseThree = null,$uniqueResult =false){
		if ($whereClause) {
				$this->db->where($whereClause);
				$this->db->where($whereClauseTwo);
				$this->db->where($whereClauseThree);
	...
	public function selectbyTwoEntityReturnResult($entityName,$whereClause = null,$whereClauseTwo = null,$uniqueResult =false){
		if ($whereClause) {
				$this->db->where($whereClause);
				$this->db->where($whereClauseTwo);
		}
	...
	public function selectbyTwoEntityTest($entityName,$whereClause = null,$whereClauseTwo = null,$uniqueResult =false,$generateKey =False){
		if ($whereClause) {
				$this->db->where($whereClause);
				$this->db->where($whereClauseTwo);
		}
    ...
    function deleteData($entityName,$whereClause){
		...
		function saveOrUpdateItemByTwoEntity($entityName,$data,$whereClause = NULL,$whereClauseTwo = NULL,$generateKey =  FALSE){
		...
		function saveOrUpdateItemByThreeEntity($entityName,$data,$whereClause = NULL,$whereClauseTwo = NULL,$whereClauseThree = NULL,$generateKey =  FALSE){
		...
		function deleteDataThreeClause($entityName,$whereClause,$whereClauseTwo,$whereClauseThree){
		$this->db->where($whereClause);
		$this->db->where($whereClauseTwo);
		$this->db->where($whereClauseThree);
		$this->db->delete($entityName);
